...
<%@ page import="web_1021.com.imsoft.dto.M002Dto" %>
<!DOCTYPE html>
<html>
  <head>
    <style>
  ...
  <body>
    ...
    <table>
      ...
      <tbody>
      <% 
       ArrayList list  = (ArrayList)request.getAttribute("query");//用list來存放傳過來的東西
  	   
      for(int i = 0 ; i<list.size() ; i++){
    	  M002Dto dto =  (M002Dto)list.get(i); // 如果new一個新的，每次跑完迴圈之後都會重新存進去，到最後裡面只剩下最後放進去的那個
